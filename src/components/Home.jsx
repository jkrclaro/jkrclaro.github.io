            ...
            <div className='col-lg-12'>
                <div className='row'>
                    <div className='col-lg-10'>
                        ...
                        <p>I left DistilledSCH to work on <a href='https://www.internetpioneerx.com'>Internet Pioneer X</a>.</p>
                        <p>If you want to contact me, you can reach me via one of the following communication channels:</p>
                        <ul>
                            <li>email via <a href='mailto:john@internetpioneerx.com' style={underlineStyle}>john@internetpioneerx.com</a></li>
