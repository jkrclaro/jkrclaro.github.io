        ...
        return (
            <div className='row'>
                <div className='col-lg-7'>
                    ...
                    <p>
                        I was born in the Philippines, grew up in Ireland and previously studied applied computing at WIT. I'm actively working on <a href='https://www.sloopback.com' target='_blank' rel='noopener noreferrer'>Sloopback</a>.
                    </p>
                    <p>
