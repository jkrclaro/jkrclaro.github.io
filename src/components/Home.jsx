        ...
        return (
            <div className='row'>
                <div className='col-lg-5 mt-3 mb-3'>
                    ...
                    <p>
                        Previously worked as data engineer at <a href='https://www.distilledsch.ie' target='_blank' rel='noopener noreferrer'>DistilledSCH</a>, now started <a href='https://www.sloopback.com' target='_blank' rel='noopener noreferrer'>Sloopback</a>.
                    </p>
                    <p>
